...
estonia_blog_posts = Blueprint('estonia_blog_posts',__name__)

@estonia_blog_posts.route('/estonia/create', methods=['GET', 'POST'])
@login_required
def create_post():
    form = BlogPostForm()
    country="Estonia"
...
@estonia_blog_posts.route('/estonia/<blog_validated_id>/add_project', methods=['GET', 'POST'])
@login_required
...
# View blog post
@estonia_blog_posts.route('/estonia/<int:blog_validated_id>', methods=['GET',
...
def blog_view(blog_validated_id):
    ...
    return render_template('blog_view.html', problem_name=blog_view.problem_name,
                           ...
                           total_num=total_num,
                           page3=page3, projects=projects, projects_num=projects_num, country=country)
...
# Update
@estonia_blog_posts.route('/estonia/<int:blog_validated_id>/update', methods=['GET', 'POST'])
@login_required
...
# Delete
@estonia_blog_posts.route('/estonia/<int:blog_validated_id>/delete', methods=['GET', 'POST'])
@login_required
...
@estonia_blog_posts.route('/estonia/<int:blog_validated_id>/<int:blog_info_id>/update', methods=['GET', 'POST'])
@login_required
...
@estonia_blog_posts.route('/estonia/<int:blog_validated_id>/<int:blog_info_id>/delete', methods=['GET', 'POST'])
@login_required
...
@estonia_blog_posts.route('/estonia/<int:blog_validated_id>/<int:blog_idea_id>/delete_idea', methods=['GET', 'POST'])
@login_required
...
@estonia_blog_posts.route('/estonia/<int:blog_validated_id>/<int:blog_idea_id>/update_idea', methods=['GET', 'POST'])
@login_required
...
@estonia_blog_posts.route('/estonia/<int:blog_validated_id>/<blog_project_id>/update_project', methods=['GET', 'POST'])
@login_required
...
@estonia_blog_posts.route('/estonia/<int:blog_validated_id>/<blog_project_id>/delete_project', methods=['GET', 'POST'])
@login_required
