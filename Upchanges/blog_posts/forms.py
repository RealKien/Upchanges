...
class BlogPostForm(FlaskForm):
    ...
    problem_type = RadioField('Type of Problem', choices=[('education','education'),('health','health'),('environment','environment'),('economics','economics'),('society','society')],validators=[DataRequired()])
