...
# Create
@jp_blog_posts.route('/japan/create', methods=['GET', 'POST'])
@login_required
def create_post():
    form = BlogPostForm()
    country="Japan"
...
@jp_blog_posts.route('/japan/<blog_validated_id>/add_project', methods=['GET', 'POST'])
@login_required
...
# View blog post
@jp_blog_posts.route('/japan/<int:blog_validated_id>', methods=['GET',
...
# Update
@jp_blog_posts.route('/japan/<int:blog_validated_id>/update', methods=['GET', 'POST'])
@login_required
...
# Delete
@jp_blog_posts.route('/japan/<int:blog_validated_id>/delete', methods=['GET', 'POST'])
@login_required
...
@jp_blog_posts.route('/japan/<int:blog_validated_id>/<int:blog_info_id>/update', methods=['GET', 'POST'])
@login_required
...
@jp_blog_posts.route('/japan/<int:blog_validated_id>/<int:blog_info_id>/delete', methods=['GET', 'POST'])
@login_required
...
@jp_blog_posts.route('/vietnam/<int:blog_validated_id>/<int:blog_idea_id>/delete_idea', methods=['GET', 'POST'])
@login_required
...
@jp_blog_posts.route('/japan/<int:blog_validated_id>/<int:blog_idea_id>/update_idea', methods=['GET', 'POST'])
@login_required
...
@jp_blog_posts.route('/japan/<int:blog_validated_id>/<blog_project_id>/update_project', methods=['GET', 'POST'])
@login_required
...
@jp_blog_posts.route('/japan/<int:blog_validated_id>/<blog_project_id>/delete_project', methods=['GET', 'POST'])
@login_required
