...
ghana_blog_posts = Blueprint('ghana_blog_posts',__name__)

@ghana_blog_posts.route('/ghana/create', methods=['GET', 'POST'])
@login_required
def create_post():
    form = BlogPostForm()
    country="Ghana"
...
@ghana_blog_posts.route('/ghana/<blog_validated_id>/add_project', methods=['GET', 'POST'])
@login_required
...
# View blog post
@ghana_blog_posts.route('/ghana/<int:blog_validated_id>', methods=['GET',
...
# Update
@ghana_blog_posts.route('/ghana/<int:blog_validated_id>/update', methods=['GET', 'POST'])
@login_required
...
# Delete
@ghana_blog_posts.route('/ghana/<int:blog_validated_id>/delete', methods=['GET', 'POST'])
@login_required
...
@ghana_blog_posts.route('/ghana/<int:blog_validated_id>/<int:blog_info_id>/update', methods=['GET', 'POST'])
@login_required
...
@ghana_blog_posts.route('/ghana/<int:blog_validated_id>/<int:blog_info_id>/delete', methods=['GET', 'POST'])
@login_required
...
@ghana_blog_posts.route('/ghana/<int:blog_validated_id>/<int:blog_idea_id>/delete_idea', methods=['GET', 'POST'])
@login_required
...
@ghana_blog_posts.route('/ghana/<int:blog_validated_id>/<int:blog_idea_id>/update_idea', methods=['GET', 'POST'])
@login_required
...
@ghana_blog_posts.route('/ghana/<int:blog_validated_id>/<blog_project_id>/update_project', methods=['GET', 'POST'])
@login_required
...
@ghana_blog_posts.route('/ghana/<int:blog_validated_id>/<blog_project_id>/delete_project', methods=['GET', 'POST'])
@login_required
