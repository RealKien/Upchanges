...
#View blog post
@usa_blog_posts.route('/usa/<int:blog_validated_id>') #int makes a string a number so that BlogPost.query doesn't show error(because data can only stored as number)
