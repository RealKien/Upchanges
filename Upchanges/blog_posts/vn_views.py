...
#View blog post
@vn_blog_posts.route('/vietnam/<int:blog_validated_id>') #int makes a string a number so that BlogPost.query doesn't show error(because data can only stored as number)
