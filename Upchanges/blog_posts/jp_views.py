...
# View blog post
@jp_blog_posts.route('/japan/<int:blog_validated_id>')  # int makes a string a number so that BlogPost.query doesn't show error(because data can only stored as number)
